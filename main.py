...
def args_define():
    ...
    parser.add_argument('--latent-dim', type=int, default=32, metavar='L', help='latent dimensionality (default: 32)')
    parser.add_argument('--batch-size', type=int, default=10, metavar='N', help='batch size of model [default: 10]')
    parser.add_argument('--iteration', type=int, default=10, metavar='N', help='No of iterations (mvae+mh) [default: 10]')
    parser.add_argument('--mvae-epochs', type=int, default=30, metavar='N', help='No of epochs of mvae [default: 10]')
    parser.add_argument('--mh-epochs', type=int, default=50, metavar='N', help='No of epochs of MH naming game [default: 10]')
